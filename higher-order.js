...
let evenNumbers = mixedNumbers.filter(e => e % 2 === 0) /* Provide Your Callback Here */
...
let postTaxPrices = prices.map(e => e * 1.07) /* Provide Your Callback Here */
...
let myStrongest = monstersInYourPocket.filter(e => e.CP > 200) // Your code here
...
let bobsTotal = purchases.filter(e => e.owner === 'Bob').reduce((acc, e) => {
        return acc + e.price
}, 0) // Your code here
